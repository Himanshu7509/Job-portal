          ...
          <div className="flex flex-col space-y-8">
              ...
              {isOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
                ...
                >
                  <div className="rounded-lg">
                    ...
                    <div className="mb-6">
                      <h2 className="text-2xl font-bold text-transparent bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text mb-4 mt-12">
                        Search by Job Title
                      </h2>
                      <div className="relative">
                        <input
                    ...
                    <div className="mb-6">
                      <h2 className="text-2xl font-bold text-transparent bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text mb-6">
                        Location
                      </h2>
            ...
            <div className="flex-1 px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
                    ...
                    <select className="border border-gray-700 rounded-md p-2 text-sm mt-4 sm:mt-0">
                      ...
                      >
                        <div className="flex w-full mb-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-gray-500 font-semibold mb-1">{job.company}</p>
                            <span className="text-gray-500 font-semibold">{job.postedTime}</span>
                          </div>
                        </div>
