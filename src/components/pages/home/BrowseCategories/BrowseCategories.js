...
const BrowseCategories = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 md:p-12 lg:p-10">
      <h1 className="lg:text-4xl text-3xl font-bold mb-4 bg-gradient-to-r from-pink-500 to-blue-500 text-transparent bg-clip-text">Browse talent by category</h1>
