...
<div className="w-full min-h-screen p-2 sm:p-4 md:p-6 lg:p-8 lg:ml-0 xl:ml-64">
      <div className="max-w-7xl mx-auto bg-white rounded-lg p-4 sm:p-6">
        ...
        <div className="w-full rounded-lg mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-2 sm:p-4">
            ...
            >
              {application.shortListed ? "✓ Shortlisted" : "Click Here To Shortlist"}
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-sky-50 rounded-xl p-4 sm:p-6 col-span-1 lg:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { label: "Company Website", value: job?.companyURL, isLink: true }
              ].map((field, index) => (
                <div key={index} className="p-3 sm:p-4 rounded-lg">
                  <p className="text-gray-600 text-sm font-medium mb-2">{field.label}</p>
                  {field.isLink ? (
                    <a href={field.value} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all text-sm sm:text-base">
                      {field.value}
                    </a>
                  ) : (
          ...
          <div className="bg-sky-50 rounded-xl p-4 sm:p-6 flex flex-col items-center justify-center">
            ...
            <span className={`px-3 sm:px-4 py-2 sm:py-3 rounded-full text-base sm:text-lg font-medium flex items-center gap-2 transition-all duration-300 ${
              application.shortListed ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
            }`}>
              {application.shortListed ? 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mt-6">
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-sky-50 p-4 sm:p-6 rounded-xl max-h-[200px] overflow-y-auto">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Skills</h3>
            ...
            <div className="bg-sky-50 p-4 sm:p-6 rounded-xl">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Links</h3>
              <p className="text-gray-700 text-sm font-medium mb-2">Project URL</p>
          ...
          <div className="bg-sky-50 rounded-xl p-4 sm:p-6 col-span-1 lg:col-span-2">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 mb-4 sm:mb-6">
                ...
                <p className="text-gray-700 text-xl sm:text-2xl font-semibold">{applicant.fullName}</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index}>
                    <h4 className="text-base sm:text-lg font-semibold text-gray-700">{field.label}</h4>
                    <p className="text-gray-700 leading-relaxed text-sm sm:text-base">{field.value}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mt-6">
          <div className="bg-sky-50 p-4 sm:p-6 rounded-xl">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 mb-4 sm:mb-6">
                ...
                <p className="text-gray-700 text-xl sm:text-2xl font-semibold">{applicant.address}</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
          ...
          <div className="bg-sky-50 p-4 sm:p-6 rounded-xl">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-4">Summary</h3>
